 ...
 * 改密码
 */
export const changePassword = (titleId, oldpassWord, newpassword, confirmpassword, captcha_code) => fetch('/v2/changepassword', {
  titleId,
  oldpassWord,
  newpassword,
  confirmpassword,
...
export const apiRequestTitle = () => fetch('http://app.lehumall.com/mobile-web-user/ws/mobile/v1/index/getTitle', {}, 'POST');

/**
 * 请求lehu内容区数据
 */
export const apiRequestContent = (titleId, timeStamp) => fetch('http://app.lehumall.com/mobile-web-user/ws/mobile/v1/index/getTitleDate', {
  titleId,
  timeStamp,
}, 'POST');
