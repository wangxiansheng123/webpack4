  ...
  <section id='foot_guide'>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      <defs>
        ...
        <symbol xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 38 38" id="lehu_home">
          <defs>
            <path id="lehu_home-regular.c151d62_a"
            ...
            <mask id="lehu_home-regular.c151d62_c" width="18" height="21" x="0" y="0" fill="#fff">
              <use xlink:href="#lehu_home-regular.c151d62_a"></use>
            </mask>
            <path id="lehu_home-regular.c151d62_b"
            ...
            <mask id="lehu_home-regular.c151d62_d" width="38" height="16" x="0" y="0" fill="#fff">
              <use xlink:href="#lehu_home-regular.c151d62_b"></use>
            </mask>
          </defs>
          <g fill="none" fill-rule="evenodd" stroke="#666" stroke-width="4">
            <use mask="url(#lehu_home-regular.c151d62_c)" xlink:href="#lehu_home-regular.c151d62_a"></use>
            <use mask="url(#lehu_home-regular.c151d62_d)" xlink:href="#lehu_home-regular.c151d62_b"></use>
          </g>
        </symbol>

        <symbol viewBox="0 0 38 38" id="lehu_homeActive">
          <defs>
            <linearGradient id="lehu_home.dbc5ebf_a" x1="50%" x2="50%" y1="100%" y2="0%">
              <stop offset="0%" stop-color="#2BAEFF"></stop>
              <stop offset="100%" stop-color="#0095FF"></stop>
            </linearGradient>
          </defs>
          <path fill="url(#lehu_home.dbc5ebf_a)" fill-rule="evenodd"
    ...
    <section @click="gotoAddress('/lehu_home')" class="guide_item">
      <svg class="icon_style">
        <use xmlns:xlink="http://www.w3.org/1999/xlink"
             :xlink:href="$route.path.indexOf('lehu_home') !== -1? '#lehu_homeActive' : '#lehu_home'"></use>
      </svg>
      <span>乐虎</span>
    </section>
